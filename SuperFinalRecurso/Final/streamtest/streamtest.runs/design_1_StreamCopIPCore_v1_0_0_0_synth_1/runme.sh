...
HD_PWD='D:/Documents/UA/CR/CR18.git/Delivery/Final/streamtest/streamtest.runs/design_1_StreamCopIPCore_v1_0_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_StreamCopIPCore_v1_0_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_StreamCopIPCore_v1_0_0_0.tcl
