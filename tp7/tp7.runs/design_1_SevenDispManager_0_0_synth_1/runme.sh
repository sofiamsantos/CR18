...
HD_PWD='D:/Universidade/cr/tp7/tp7.runs/design_1_SevenDispManager_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_SevenDispManager_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_SevenDispManager_0_0.tcl
