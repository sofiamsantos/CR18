...
HD_PWD='C:/Users/Sofs/Documents/Projeto/streamtest/streamtest.runs/design_1_fit_timer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_fit_timer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_fit_timer_0_0.tcl
