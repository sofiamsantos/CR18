...
HD_PWD='C:/Users/Sofs/Documents/Projeto/stream/stream.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log StreamCopIPCore_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source StreamCopIPCore_v1_0.tcl -notrace
